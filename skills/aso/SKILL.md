...
- **`rank`** comes from Apple's own store search order (about 250 deep, unpersonalized iPhone results). `null` means not in the top 250 today, not "unranked forever". Users' own devices can show slightly different, personalized orders.
